...
Ennemy = function(){
  var geom = new THREE.CylinderGeometry(6,10,18);
  var mat = new THREE.MeshPhongMaterial({
    color:0X9900FF,
    shininess:0,
    specular:0xffffff,
...
EnnemiesHolder.prototype.rotateEnnemies = function(){
  for (var i=0; i<this.ennemiesInUse.length; i++){
    ...
    if (d<game.ennemyDistanceTolerance){
      particlesHolder.spawnParticles(ennemy.mesh.position.clone(), 15, 0X9900FF, 3);
...
Coin = function(){
  var geom = new THREE.BoxGeometry(21,14,1);  
  var mat = new THREE.MeshPhongMaterial({
    color:Colors.white,
    shininess:0,
    specular:0xffffff,
...
CoinsHolder.prototype.spawnCoins = function(){
  ...
  var nCoins = 1 + Math.floor(Math.random()*15);
...
CoinsHolder.prototype.rotateCoins = function(){
  for (var i=0; i<this.coinsInUse.length; i++){
    ...
    if (d<game.coinDistanceTolerance){
      ...
      particlesHolder.spawnParticles(coin.mesh.position.clone(), 8, 0X38761D, .8);
      addEnergy();
      i--;
